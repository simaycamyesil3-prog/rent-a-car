...
#canlida (DEBUG=False) hash'li dosya adlari + kirik referanslari yok sayan ozel
#depoyu kullaniyoruz (whitenoise'un dosyalari dogru sunabilmesi icin bu gerekli),
#yerelde Django'nun basit varsayilani yeterli
STORAGES = {
    'default': {
